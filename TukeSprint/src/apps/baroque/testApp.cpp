...
int testApp::getRelativeFaceIndex(int absoluteStrokeIndex){
	int indexCounter = 0;
...
int testApp::getRelativeStrokeIndex(int absoluteStrokeIndex)
{
	int indexCounter = 0;
...
void testApp::drawMasks(bool useOldData){
